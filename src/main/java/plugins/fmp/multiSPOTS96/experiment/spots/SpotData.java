...
public final class SpotData {
    ...
    public int getKymographIndex() { return kymographIndex; }
    public int getSpotCamDataT() { return spotCamDataT; }
    public int getSpotKymographT() { return spotKymographT; }
    public Optional<String> getSpotFilenameTIFF() { return Optional.ofNullable(spotFilenameTIFF); }
    public Optional<IcyBufferedImage> getSpotImage() { return Optional.ofNullable(spotImage); }
    public Optional<BooleanMask2D> getMask2DSpot() { return Optional.ofNullable(mask2DSpot); }
    public SpotProperties getProperties() { return properties; }
    public boolean isValid() { return valid; }
    public boolean isOkToAnalyze() { return okToAnalyze; }
    public ROI2DShape getRoi() { return roi; }
    
    // Computed properties
    public String getName() {
        return Optional.ofNullable(properties.sourceName)
            .orElse(roi.getName());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(getName(), spotData.getName()) &&
               Objects.equals(properties.cageID, spotData.properties.cageID);
    }
    ...
    public String toString() {
        return String.format("SpotData{name='%s', cageID=%d, valid=%b, okToAnalyze=%b}", 
                           getName(), properties.cageID, valid, okToAnalyze);
    }
