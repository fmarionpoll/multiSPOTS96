...
public final class CageData {
    ...
    public static CageData createInvalid(ROI2D roi, String reason) {
        return builder()
            .withRoi(roi)
            .withProperties(new CageProperties())
            .valid(false)
            .detectEnabled(false)
            .build();
    }
    ...
    public Optional<BooleanMask2D> getCageMask2D() { return Optional.ofNullable(cageMask2D); }
    public CageProperties getProperties() { return properties; }
    public boolean isValid() { return valid; }
    public boolean isDetectEnabled() { return detectEnabled; }
    public boolean isInitialFlyRemoved() { return initialFlyRemoved; }
