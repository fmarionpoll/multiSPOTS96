...
import static plugins.fmp.multiSPOTS96.tools.toExcel.ExcelExportConstants.DefaultOptions;

/**
 * Builder pattern implementation for XLSExportOptions.
 * Provides a fluent interface for constructing export options with proper defaults.
 */
public class XLSExportOptionsBuilder {
    ...
    public static XLSExportOptionsBuilder forSpotAreas() {
        return new XLSExportOptionsBuilder()
            .withSpotAreas(true)
            .withSum(true)
            .withAlive(true)
            .withOnlyAlive(true);
    ...
    /**
     * Creates a builder with commonly used settings for cage data export.
     * 
     * @return A pre-configured builder
     */
    ...
    public static XLSExportOptionsBuilder forChart() {
        return new XLSExportOptionsBuilder()
            .withTranspose(false)
            .withCollateSeries(true)
            .withAlive(true);
    }
    
    // Additional fluent interface methods can be added as needed
    
    private XLSExportOptionsBuilder withSum(boolean sum) {
        this.sum = sum;
        return this;
    }
    
    private XLSExportOptionsBuilder withSumPerCage(boolean sumPerCage) {
        this.sumPerCage = sumPerCage;
        return this;
    }
} 