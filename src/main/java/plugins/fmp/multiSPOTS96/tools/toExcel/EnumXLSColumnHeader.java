...
public enum EnumXLSColumnHeader {
	...
	EXP_STIM("1_Stim", 6, EnumXLSMeasure.COMMON), EXP_CONC("Conc1", 7, EnumXLSMeasure.COMMON),
	EXP_STRAIN("Strain", 8, EnumXLSMeasure.COMMON), EXP_SEX("Sex", 9, EnumXLSMeasure.COMMON),
	EXP_COND1("2_Ctrl", 10, EnumXLSMeasure.COMMON), EXP_COND2("Conc2", 11, EnumXLSMeasure.COMMON),
