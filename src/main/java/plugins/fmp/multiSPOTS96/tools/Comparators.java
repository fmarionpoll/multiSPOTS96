...
/**
 * Collection of comparator classes for MultiSPOTS96 data structures.
 * This class provides various comparator implementations for sorting
 * different types of objects used throughout the MultiSPOTS96 plugin.
 * 
 * <p>The comparators handle null values gracefully and provide consistent
 * sorting behavior for collections of ROIs, spots, cages, and other
 * experiment-related objects.</p>
 * 
 * <p>Usage example:
 * <pre>
...
public class Comparators {
    ...
    /**
     * Comparator for ROI objects based on their names.
    ...
    /**
     * Comparator for ROI2D objects based on their names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for Spot objects based on their cage position.
     * Calculates position as (cageRow * 8 + cageColumn) for consistent ordering.
     */
    ...
    /**
     * Comparator for Sequence objects based on their names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for XLSResults objects based on their names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for FlyPositions objects based on their names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for Cage objects based on their ROI names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for Spot objects based on their ROI names.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for FlyPosition objects based on their time index.
     * Handles null values by treating them as greater than non-null values.
     */
    ...
    /**
     * Comparator for Experiment objects based on their start times.
     * Compares experiments by their first image timestamps.
     * Handles null values by treating them as greater than non-null values.
     */
