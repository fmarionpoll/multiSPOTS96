...
/**
 * Container class for chart data including axis ranges and dataset.
 * This class encapsulates the data needed to create and configure charts,
 * including the XY dataset and the min/max values for both X and Y axes.
 * 
 * <p>ChartData is used to store the complete information needed to render
 * a chart, including the actual data points and the axis scaling information.
 * This makes it easier to pass chart configuration between different chart
 * creation and rendering components.</p>
 * 
 * <p>Usage example:
 * <pre>
...
public class ChartData {
    ...
    /**
     * Creates a new ChartData with null values for all components.
     * Use the setter methods to populate the data.
     */
    public ChartData() {
        this(null, null, null);
    }
    ...
    public ChartData(MaxMinDouble xMaxMin, MaxMinDouble yMaxMin, XYSeriesCollection xyDataset) {
        ...
        LOGGER.fine("Created ChartData with " + 
                   (xyDataset != null ? xyDataset.getSeriesCount() : 0) + " series");
    }
    ...
    public void setXYDataset(XYSeriesCollection xyDataset) {
        this.xyDataset = xyDataset;
        LOGGER.fine("Updated XY dataset with " + 
                   (xyDataset != null ? xyDataset.getSeriesCount() : 0) + " series");
    }
    ...
    public String getYRangeString() {
        ...
        return String.format("Y-axis range: [%.2f, %.2f]", yMaxMin.min, yMaxMin.max);
    }
    ...
    public String getXRangeString() {
        ...
        return String.format("X-axis range: [%.2f, %.2f]", xMaxMin.min, xMaxMin.max);
    }
    ...
    public String toString() {
        ...
        if (xMaxMin != null) {
            sb.append(", xRange=[").append(xMaxMin.min).append(", ").append(xMaxMin.max).append("]");
        }
        if (yMaxMin != null) {
            sb.append(", yRange=[").append(yMaxMin.min).append(", ").append(yMaxMin.max).append("]");
        }
        sb.append("]");
        return sb.toString();
    }
    ...
    /**
     * Creates a copy of this ChartData.
     * Note that the XYSeriesCollection is not deeply copied.
     * 
    ...
    /**
     * Clears all data from this ChartData.
