...
/**
 * Container class that pairs a chart panel with its associated cage.
 * This class provides a convenient way to maintain the relationship between
 * JFreeChart panels and the cage data they represent.
 * 
 * <p>The CageChartPair is used primarily in chart display systems where
 * multiple charts are generated for different cages in an experiment.
 * It provides a clean way to associate chart UI components with their
 * underlying data sources.</p>
 * 
 * <p>Usage example:
 * <pre>
...
public class CageChartPair {
    ...
    public CageChartPair(ChartPanel chartPanel, Cage cage) {
        ...
        LOGGER.fine("Created CageChartPair for cage ID: " + cage.prop.cageID);
    }
    ...
    public void setChartPanel(ChartPanel chartPanel) {
        ...
        this.chartPanel = chartPanel;
        LOGGER.fine("Updated chart panel for cage ID: " + cage.prop.cageID);
    }
    ...
    public void setCage(Cage cage) {
        ...
        this.cage = cage;
        LOGGER.fine("Updated cage for chart panel, new cage ID: " + cage.prop.cageID);
    }
    ...
    public int getCageID() {
        return cage != null ? cage.prop.cageID : -1;
    }
    ...
    public int getCagePosition() {
        return cage != null ? cage.prop.cagePosition : -1;
    }
    ...
    public String toString() {
        ...
        if (cage != null) {
            sb.append("cageID=").append(cage.prop.cageID);
            sb.append(", cagePosition=").append(cage.prop.cagePosition);
        } else {
            sb.append("cage=null");
        }
    ...
    /**
     * Checks if this pair equals another object.
     * Two CageChartPairs are considered equal if they have the same cage ID.
     * 
