...
/**
 * Chart display class for fly position data.
 * This class creates and manages charts that display various fly position
 * measurements over time, including distance, alive status, sleep status,
 * and vertical position.
 * 
 * <p>ChartPositions provides a comprehensive view of fly behavior by
 * creating multiple charts in a horizontal layout, each representing
 * different cages or measurement types.</p>
 * 
 * <p>Usage example:
 * <pre>
...
public class ChartPositions extends IcyFrame {
    ...
    public void displayData(List<Cage> cageList, EnumXLSExport option) {
        ...
        for (XYSeriesCollection xyDataset : xyDataSetList) {
            ...
            JFreeChart xyChart = ChartFactory.createXYLineChart(null, null, null, xyDataset, 
            ...
            ChartPanel xyChartPanel = new ChartPanel(xyChart, width, DEFAULT_CHART_HEIGHT, 
