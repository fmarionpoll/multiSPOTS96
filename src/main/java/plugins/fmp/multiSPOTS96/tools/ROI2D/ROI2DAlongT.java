 ...
 * Represents a ROI that exists at a specific time point with associated mask data.
 * 
...
public class ROI2DAlongT implements XMLPersistent {
    ...
    public String getSummary() {
        return String.format("ROI2DAlongT[index=%d, time=%d, hasMask=%s, points=%d]", 
                           index, timePoint, hasMaskData(), 
