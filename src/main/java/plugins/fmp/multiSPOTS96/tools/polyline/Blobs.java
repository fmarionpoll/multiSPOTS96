...
/**
 * Blob detection and analysis utility class for processing binary images.
 * This class provides methods for connected component analysis, blob extraction,
 * and geometric operations on detected blobs.
 * 
...
public class Blobs {
    ...
    /**
     * Performs connected component labeling on the binary image.
     * This method assigns unique labels to connected regions of non-zero pixels.
     * 
    ...
    /**
     * Merges connected components that were initially labeled separately.
     * This method handles cases where components are connected through diagonal
    ...
    public Polygon2D getBlobPolygon2D(int blobNumber) {
        ...
        try {
            ...
            for (Point point : allBoundaryPoints) {
                polygonPoints.add(new Point2D.Double(
                    point.x + PIXEL_CENTER_OFFSET, 
                    point.y + PIXEL_CENTER_OFFSET));
            }
