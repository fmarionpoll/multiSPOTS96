...
/**
 * Custom viewer class for MultiSPOTS96 with title refresh control.
 * This class extends the standard Icy Viewer to provide additional
 * functionality for controlling when the viewer title is refreshed.
 * 
 * <p>ViewerFMP is used in the MultiSPOTS96 plugin to prevent unwanted
 * title updates during certain operations, such as when loading data
 * or performing batch operations.</p>
 * 
 * <p>Usage example:
 * <pre>
...
public class ViewerFMP extends Viewer {
    ...
    /**
     * Temporarily inhibits title refresh for the duration of the provided operation.
     * This is a convenience method for performing operations without title updates.
     * 
    ...
    public String toString() {
        return String.format("ViewerFMP[inhibitRefresh=%s, visible=%s]", 
                           inhibitRefreshViewerTitle, isVisible());
    }
}
