...
public class LoadSaveOptimizedUsageExample {
	...
	public static void exampleMemoryConstrainedConfig() {
		...
		/*
		 * private static final int BATCH_SIZE = 5; // Smaller batches private static
		 * final int MAX_CONCURRENT_THREADS = 2; // Fewer threads private static final
		 * int CACHE_SIZE = 50; // Smaller cache
		 */
