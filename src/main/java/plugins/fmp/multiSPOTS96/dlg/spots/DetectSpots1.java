...
public class DetectSpots1 extends JPanel
	...
	*/
	...
	JComboBox<ImageTransformEnums> transformComboBox = new JComboBox<>(transforms);
...
// -----------------------------------------------------
	...
	private BuildSeriesOptions initTrackParameters(Experiment exp) {
		...
		options.referenceFrame = exp.seqCamData.currentFrame;
