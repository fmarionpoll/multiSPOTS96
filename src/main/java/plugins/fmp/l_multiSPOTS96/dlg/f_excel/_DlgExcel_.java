package plugins.fmp.l_multiSPOTS96.dlg.f_excel;
...
import plugins.fmp.l_multiSPOTS96.tools.toExcel.XLSExportMeasuresCagesAsQuery;
import plugins.fmp.l_multiSPOTS96.tools.toExcel.XLSExportMeasuresFromSpot;
import plugins.fmp.l_multiSPOTS96.tools.toExcel.XLSExportOptions;
import plugins.fmp.l_multiSPOTS96.tools.toExcel.exceptions.ExcelExportException;
...
public class _DlgExcel_ extends JPanel implements PropertyChangeListener {
	...
	public void init(JPanel mainPanel, String string, L_MultiSPOTS96 parent0) {
