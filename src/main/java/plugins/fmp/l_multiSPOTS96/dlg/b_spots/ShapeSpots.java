package plugins.fmp.l_multiSPOTS96.dlg.b_spots;
...
import plugins.fmp.l_multiSPOTS96.experiment.cages.Cage;
import plugins.fmp.l_multiSPOTS96.experiment.spots.Spot;
import plugins.fmp.l_multiSPOTS96.series.BuildSeriesOptions;
import plugins.fmp.l_multiSPOTS96.tools.ROI2D.Measures;
import plugins.fmp.l_multiSPOTS96.tools.canvas2D.Canvas2D_3Transforms;
import plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformEnums;
import plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformInterface;
import plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformOptions;
import plugins.fmp.l_multiSPOTS96.tools.overlay.OverlayThreshold;
...
public class ShapeSpots extends JPanel {
	...
	void init(GridLayout gridLayout, L_MultiSPOTS96 parent0) {
