...
import plugins.fmp.l_multiSPOTS96.tools.JComponents.JComboBoxColorRenderer;
...
public class ThresholdColors extends JPanel implements PropertyChangeListener {
	...
	L_MultiSPOTS96 multiSpots = null;

	public void init(GridLayout capLayout, L_MultiSPOTS96 parent0) {
