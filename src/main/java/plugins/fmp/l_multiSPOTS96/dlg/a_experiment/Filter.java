package plugins.fmp.l_multiSPOTS96.dlg.a_experiment;
...
import plugins.fmp.l_multiSPOTS96.L_MultiSPOTS96;
import plugins.fmp.l_multiSPOTS96.experiment.Experiment;
import plugins.fmp.l_multiSPOTS96.experiment.ExperimentProperties;
import plugins.fmp.l_multiSPOTS96.experiment.LazyExperiment;
import plugins.fmp.l_multiSPOTS96.tools.DialogTools;
import plugins.fmp.l_multiSPOTS96.tools.JComponents.JComboBoxExperimentLazy;
import plugins.fmp.l_multiSPOTS96.tools.toExcel.EnumXLSColumnHeader;
...
public class Filter extends JPanel {
	...
	private L_MultiSPOTS96 parent0 = null;
	public JComboBoxExperimentLazy filterExpList = new JComboBoxExperimentLazy();

	void init(GridLayout capLayout, L_MultiSPOTS96 parent0) {
	...
	private void defineActionListeners() {
		...
		exptBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(exptBtn,
		...
		stim1Btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(stim1Btn,
		...
		conc1Btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(conc1Btn,
		...
		sexBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(sexBtn,
		...
		strainBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(strainBtn,
		...
		stim2Btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(stim2Btn,
		...
		conc2Btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(final ActionEvent e) {
				...
				List<String> chosen = plugins.fmp.l_multiSPOTS96.tools.JComponents.MultiSelectDialog.showDialog(conc2Btn,
