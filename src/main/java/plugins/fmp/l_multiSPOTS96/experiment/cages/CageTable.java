...
import plugins.fmp.l_multiSPOTS96.tools.JComponents.TableCellColorEditor;
import plugins.fmp.l_multiSPOTS96.tools.JComponents.TableCellColorRenderer;
...
public class CageTable extends JTable {
	...
	public CageTable(L_MultiSPOTS96 parent0) {
