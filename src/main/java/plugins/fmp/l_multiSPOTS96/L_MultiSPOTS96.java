package plugins.fmp.l_multiSPOTS96;
...
import plugins.fmp.l_multiSPOTS96.dlg.a_browse._DlgBrowse_;
import plugins.fmp.l_multiSPOTS96.dlg.a_experiment._DlgExperiment_;
import plugins.fmp.l_multiSPOTS96.dlg.b_spots._DlgSpots_;
import plugins.fmp.l_multiSPOTS96.dlg.d_spotsMeasures._DlgSpotMeasure_;
import plugins.fmp.l_multiSPOTS96.dlg.f_excel._DlgExcel_;
import plugins.fmp.l_multiSPOTS96.tools.DescriptorIndex;
import plugins.fmp.l_multiSPOTS96.tools.JComponents.JComboBoxExperimentLazy;

public class L_MultiSPOTS96 extends PluginActionable {
	...
	public static void main(String[] args) {
		...
		PluginLauncher.start(PluginLoader.getPlugin(L_MultiSPOTS96.class.getName()));
	}
