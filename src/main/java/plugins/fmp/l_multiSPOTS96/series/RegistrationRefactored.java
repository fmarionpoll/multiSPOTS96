...
public class RegistrationRefactored extends BuildSeries {
     ...
     */
    private plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformOptions createImageTransformOptions(
            plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformEnums transformEnum) {
        plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformOptions options = 
            new plugins.fmp.l_multiSPOTS96.tools.imageTransform.ImageTransformOptions();
