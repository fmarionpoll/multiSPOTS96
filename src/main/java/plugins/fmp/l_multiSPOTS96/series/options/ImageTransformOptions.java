package plugins.fmp.l_multiSPOTS96.series.options;
...
public class ImageTransformOptions {
    ...
    public static ImageTransformOptions fromLegacyOptions(plugins.fmp.l_multiSPOTS96.series.BuildSeriesOptions legacy) {
        return builder()
